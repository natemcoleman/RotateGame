...
def ReturnFaces():
    ...
    face5 = [4, 6]
    face6 = [5, 7]
    return [face1, face2, face5, face6]


def ReturnPositions():
    return [(0, 45.825757), (-13.671875, 36.962208), (13.671875, 36.962208), (0, 31.721444), (0, -31.721444), (-13.671875, -36.962208), (13.671875, -36.962208), (0, -45.825757)]
...
def CreateAllPoints():
    ...
    return [red1, red2, red3, blue1, yellow3, cyan1, cyan2, cyan3]
...
def ReturnCircleMovements():
    ...
    return [rotateCircle1CCW, rotateCircle2CCW, rotateCircle4CCW, rotateCircle5CCW]
